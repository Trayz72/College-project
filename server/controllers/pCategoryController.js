...
exports.createProductCategory = (req, res) => {
  const sql =
    "INSERT INTO product_category_table (Product_Category_Name) VALUES (?)";
...
exports.getAllProductCategory = (req, res) => {
  const sql = "SELECT * FROM product_category_table";
...
exports.updateProductCategory = (req, res) => {
  const sql = `UPDATE product_category_table SET Product_Category_Name = ? WHERE Product_Category_Id = ?`;
...
exports.getProductCategoryRecord = (req, res) => {
  const sql =
    "SELECT * FROM product_category_table WHERE Product_Category_Id = ?";
  const id = req.params.id;
