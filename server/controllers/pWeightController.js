...
exports.createProductWeight = (req, res) => {
  const sql = "INSERT INTO product_weight_table (Product_Weight) VALUES (?)";
...
exports.getAllProductWeight = (req, res) => {
  const sql = "SELECT * FROM product_weight_table";
...
exports.updateProductWeight = (req, res) => {
  const sql = `UPDATE product_weight_table SET Product_Weight = ? WHERE Product_Weight_Id = ?`;
...
exports.getProductWeightRecord = (req, res) => {
  const sql = "SELECT * FROM product_weight_table WHERE Product_Weight_Id = ?";
  const id = req.params.id;
